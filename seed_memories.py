...
"""One-time script: pre-seed OmniAI's memory with everything we know about $USER.
...
seeds = {
    ...
    "user_aesthetic":      "hacker/cyber aesthetic, dark themes, teal/cyan accent colors, space vibes. $USER character = robot in cyan hoodie inside gear badge",
    ...
    # Python
    "python_venv_main":    "~/interpreter-venv — main Python venv for OmniAI and most scripts",
    "python_venv_aider":   "~/aider-venv — aider code editing tool",
    "python_venv_audio":   "~/ai-audio-venv — Whisper speech recognition",
    ...
    "project_omniai":      "~/omni-stack — OmniAI itself: omni-ai.py (agent brain), omni-panel.py (Textual TUI), omni-icon.png ($USER-style icon). Launched from ~/Desktop/OmniAI.desktop",
    ...
    "pref_remember":       "When $USER says 'remember' anything, always call remember() to persist it",
    "pref_errors":         "When something fails, diagnose root cause. Don't retry blindly.",
    "pref_colors":         "Use cyan/teal colors in output (Rich). Matches $USER aesthetic.",
    ...
    "friend_xander":       "Discord friend who uses Open-WebUI and Stable Diffusion. Suggested those tools to $USER.",
}
