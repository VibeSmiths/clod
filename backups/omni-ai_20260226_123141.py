...
def run_self_test() -> str:
    ...
    for marker in ("# @@INSERT_TOOL@@", "def recursive_directory_traversal(path):
    import os
...
# @@INSERT_FUNCTION@@", "# @@INSERT_MAPPING@@"):
...
def self_improve(tool_name: str, description: str, function_code: str,
    ...
    MAP_MARKER  = "    "recursive_directory_traversal": recursive_directory_traversal,
    # @@INSERT_MAPPING@@"
